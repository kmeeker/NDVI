---
title: "RPi NoIR Camera Plant Photosynthesis Measurement"
author: "Kirsten Meeker" 
date: "Oct 1, 2016"
output: html_document
---

[//]: #(<style> .ninety {font-size: 90%;} </style>)
...
<img src="figures/NoIR.png" width="425"/> <img src="figures/infrared-combination.png" width="425"/> 
...
## Transpiration
Transpiration is the process of water movement through a plant and its evaporation from aerial parts, such as leaves, stems and flowers. Water is necessary for plants but only a small amount of water taken up by the roots is used for growth and metabolism. The remaining 97-99.5% is lost by transpiration and guttation. https://en.wikipedia.org/wiki/Transpiration
...
3D printed camera case http://www.thingiverse.com/thing:427546    
